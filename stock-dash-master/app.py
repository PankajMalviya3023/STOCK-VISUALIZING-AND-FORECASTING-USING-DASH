        ...
        html.Div(
            [
                ...
                html.Div([
                    ...
                    html.Div([
                        dcc.Input(id="dropdown_tickers", type="text" , placeholder="Enter stock code only"),
...
def update_data(n, val):  # inpur parameter(s)
    if n == None:
        return "Hey there! Please enter a legitimate stock code to get details.", "https://a.pinatafarm.com/1858x1304/ff543bb12a/stonks-without-stonks.jpg", "Stocks", None, None, None
        # raise PreventUpdate
    else:
        if val == None:
            raise PreventUpdate
